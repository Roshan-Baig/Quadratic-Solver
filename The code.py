...
def findSol():
        ...
        R1 = Label(m,text = "The first solution"+str(sol1)).place(x = 0, y = 150)
        R2 = Label(m,text = "The second solution"+str(sol2)).place(x = 310, y = 150)
def click(*arg):
        A.delete(0,"end")
        B.delete(0,"end")
        C.delete(0,"end")
...
b1 = Button(m,text = "calculate",command = findSol)
